/**
  ...
  *
  * @checksum - 9290dd6d959250f8d370298dfd9ac56295c5b60a15ac82d1c6685b5750c2536e
  * @variables - radius=rounded-lg,accentColor=emerald,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[24em],tagRadius=rounded-full,swatchRadius=rounded
  * @theme - regenesis
  **/
